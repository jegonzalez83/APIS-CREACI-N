...
//Esta es otra forma de llamar a cada uno de los modelos
const Movies = db.Movie;
const Genres = db.Genre;
const Actors = db.Actor;

//Dentro del actorsAPIController se debe/ o se puede? usar las dos forma de poder llamar a nuestros modelo
