...
//Se dispone la posibilidad para utilizar el seteo en los formularios para el uso de los metodos put /ó delete
app.use(methodOverride('_method'));

app.use('/', indexRouter);
app.use(moviesRoutes);
app.use(genresRoutes);
//Se crea la colección de los recursos de movies (APIs)
app.use('/api/movies',apiMoviesRouter);
app.use('/api/actors',apiActorsRouter);
app.use('/api/genres',apiGenresRouter);


//Levantando el servidor desde express
